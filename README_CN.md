...
- **评测基准**: [tau2-bench](https://github.com/sierra-research/tau2-bench) airline（Gym API + 官方 splits）
...
- [tau2-bench](https://github.com/sierra-research/tau2-bench) 挑战性长链路智能体评测基准
