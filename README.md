...
## 🔥 Historical PRM-Lite + LATA Results
...
│   │   ├── 🐍 tau2_adapter.py          # Current AgentGymEnv adapter
│   │   ├── 🐍 progpo_progress.py      # Exact first-visit coverage
...
- **Benchmark**: [tau2-bench](https://github.com/sierra-research/tau2-bench) airline via Gym API and official splits
...
- [tau2-bench](https://github.com/sierra-research/tau2-bench) for the challenging long-horizon agent benchmark
