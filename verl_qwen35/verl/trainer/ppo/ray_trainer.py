...
def compute_advantage(
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        if adv_estimator in custom_adv_estimators:
            if "progress_score" in data.non_tensor_batch:
        ...
        if progpo_diagnostics:
            ...
            for field in ("progress_tool_score", "progress_user_score"):
                if field in data.non_tensor_batch:
                    ...
                    progpo_diagnostics[f"progpo/{field}_mean"] = float(values.mean())
            data.meta_info["progpo_metrics"] = progpo_diagnostics
    return data
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        metrics.update(batch.meta_info.get("progpo_metrics", {}))
